...
\begin{figure}[H]
	...
	\end{subfigure}%
\vspace*{20pt}\caption{Correlation plots showing probability cases for land cover classes in the Inner Niger Delta between 2013 and 2022 based on clustering of the Landsat 8-9 OLI/TIRS images: (\textbf{a}) Kendall correlation; (\textbf{b}) Pearson correlation. Mapping: Python. Source: authors.}\label{fig:13}
\end{figure}
