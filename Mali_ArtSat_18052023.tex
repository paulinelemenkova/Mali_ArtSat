...
\newpar In this study, we demonstrated the integrated use of the three types of scripting techniques -- GMT, R and Python -- as effective tools for processing Earth observation data. The advanced use of R language for satellite image processing provides new insights into complex interlace of climate-hydrological processes and vegetation responses based on automatic classification of the Landsat OLI/TIRS bands. \hl{The full programming codes used in this study for the Python and R languages, and GMT scripts} are publicly provided in the open GitHub repository of the authors using the following link: \href{https://github.com/paulinelemenkova/Image_Processing_Mali_IND_Scripts}{https://github.com/paulinelemenkova/Image\_Processing\_Mali\_IND\_Scripts}. 
