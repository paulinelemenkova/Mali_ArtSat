...
\newpar The cartographic technical characteristics common for each Landsat OLI/TIRS bands include the coordinate reference system World Geodetic System (WGS) 84, the Universal Transverse Mercator (UTM) zone 30N (EPSG:32630) and the spatial resolution of most of the bands at 30 meters. Specifically, the OLI multispectral bands have pixel size 30 m. These includes Bands 1 to 7: Band 1 (Coastal aerosol), Band 2 (Blue), Band 3 (Green), Band 4 (Red), Band 5 - Near Infrared (NIR), Band 6 (SWIR 1), Band 7 (SWIR 2) and Band 9 (Cirrus). The panchromatic Band 8\hl{ }and \hl{Thermal Infrared (TIRS) 1 and 2 bands were not used in this study. Here, we used} the multispectral bands which \hl{allow the} precision of the maps to 30 m per pixel.
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Landsat 8 OLI/TIRS image of Inner Niger Delta in natural colour RGB values showing floodplain for six years (always November): (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022.}\label{fig:03}
\end{figure}
...
\newpar The SpatRaster was created from the Bands 4 and 5 as a spatially referenced surface in RStudio (Figure \ref{fig04}). 
...
\newpar The correlation analysis was performed using plots of Kendall \hl{correlation method} \citep{Kendall1938} and Pearson \hl{correlation method} \citep{Pearson1895}\hl{. Both methods are used to measure the association between the two measured quantities, that is, land cover classes and the probability of the correct association of the pixels assigned to these classes. In} Python\hl{, these algorithms were implemented }by the code \hl{presented in Listing} \ref{lst:06} \hl{in the Appendix} (here a case for Pearson method, modified and applied for the case of Kendall method). \hl{The correlation between two computed land cover classes is high when observations have a similar values, and vice versa.}

\newpar \hl{Complex cases in classification process included the similar values of the land cover classes including both plant and water areas which consist of connected lakes, channels, and marshes of the Inner Niger Delta. Therefore, the check of the classification was done using statistical analysis by double correlation of the same class and correctness of the pixels that could be assigned to two different but similar classes because of the similar spectral reflectance values. To this end, the probability cases for land cover classes were computed in Python. }

\newpar \hl{using Python, we tested the probability of the assigned pixels to correspond to the correct classes in several types of the land cover classes on the correlation plots, including the following 20 associated land cover classes in the Inner Niger Delta, Mali: 1) Woodland; 2) Floodplain with aquatic grassland; 3) Savannah; 4) Thicket; 5) Wild rice; 6) Grassland; 7) Irrigated rice fields; 8) Savannah in shallow floodplain; 9) Bare soil (loams and clays); 10) Bare soil (sands); 11) Vegetation mosaics, main channel banks; 12) Lacustrine woodland; 13) Shallow lacustrine woodland; 14) Shrubby savannah in uplands; 15) Anthropic woody savannah; 16) Thicket in uplands; 17) Woody savannah in uplands; 18) Shrubby savannah in uplands; 19) Island palm grove; 20) Margins palm grove. }
...
\begin{figure}[H]
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.95\textwidth]{Fig_05a.png}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{Fig_05b.png}
		\caption{2015}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.95\textwidth]{Fig_05c.png}
		\caption{2018}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{Fig_05d.png}
		\caption{2020}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.95\textwidth]{Fig_05e.png}
		\caption{2021}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{Fig_05f.png}
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{NDVI based on Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping: RStudio. Source: authors.}\label{fig:05}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of the NDVI based on the Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig:06}
\end{figure}
...
\begin{figure}[H]
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=.95\textwidth]{Fig_07a.jpg}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=.95\textwidth]{Fig_07b.jpg}
		\caption{2015}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=.95\textwidth]{Fig_07c.jpg}
		\caption{2018}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=.95\textwidth]{Fig_07d.jpg}
		\caption{2020}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=.95\textwidth]{Fig_07e.jpg}
		\caption{2021}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=.95\textwidth]{Fig_07f.jpg}
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Soil Adjusted Vegetation Index (SAVI) based on the Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig:07}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of SAVI based on the Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig:08}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Enhanced Vegetation Index (EVI) based on the Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig:09}
\end{figure}

\newpar Clearly visible two peaks on the histograms (Figure \ref{fig:10}) correspond to the flooded inundated water-covered areas with negative values (EVI from 0 to -0.35 in a general extent)\hl{. The lower} data \hl{are }typical for floodplains and aquatic plants \hl{which contrast} against the bright vegetation areas that correspond to the grasslands, savannah and thickets (EVI values from 0.30 to 0.68)\hl{. Finally,} the middle values that are typical for the agricultural areas (rice) \hl{have} mediocre values (EVI values from 0.20 to 0.30). 
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of EVI based on the Landsat 8-9 OLI/TIRS images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig:10}
\end{figure}
...
\begin{figure}[H]
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.78\textwidth]{Fig_11a.jpg}
...
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.78\textwidth]{Fig_11c.jpg}
...
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.78\textwidth]{Fig_11e.jpg}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{}%\vspace{1mm}
	\end{subfigure}%
\vspace*{20pt}\caption{Correlation plots showing probability cases for land cover classes in the Inner Niger Delta between 2013 and 2022 based on the results of the clustering of the Landsat 8-9 OLI/TIRS images: (\textbf{a}) Kendall correlation; (\textbf{b}) Pearson correlation. Mapping: Python. Source: authors.}\label{fig:13}
\end{figure}
...
\begin{lstlisting}[language=R,caption=R code used for unsupervised classification by k-means clustering, basicstyle=\ttfamily\scriptsize,keywordstyle=\color{deepmagenta},emphstyle=\color{deepred},
...
\begin{lstlisting}[language=python,caption=Python code used for data inspection by correlation analysis, basicstyle=\ttfamily\scriptsize,keywordstyle=\color{deepmagenta},emphstyle=\color{deepred},
