...
\centering
	...
	\vspace*{20pt}\caption{Topographic map of Mali. Mapping software: Generic Mapping Tools (GMT) scripting toolset. Data source: GEBCO/SRTM. Cartography source: authors.
	\label{fig01}}
\end{figure}
