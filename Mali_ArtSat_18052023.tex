...
\newpar The correlation analysis was performed using plots of Kendall and Pearson methods in Python by the code \hl{in Listing} \ref{lst:06} \hl{in the Appendix} (here a case for Pearson method, modified and applied for the case of Kendall method).  
