...
\newpar The results of the NDVI computation show changes in vegetation from 2013 to 2022, Figure \ref{fig07}. The comparison of the computed values \hl{is} summarised in Table \ref{tab2} based on the SpatRaster from Bands 4 and 5 of the Landsat \hl{8-9} satellite images and shown in histograms of Figure \ref{fig08}. The lowest NDVI values in the study area were obtained from the Landsat-\hl{9} image in 2022/11/11 as -0.3072812, while the highest data are 0.5879165 received from the Landsat-\hl{8} image in 2013/11/10. 
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{NDVI based on Landsat \hl{8-9} images of Inner Niger Delta: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping: RStudio. Source: authors.}\label{fig07}
\end{figure}

Figure \ref{fig08} shows the frequency of the NDVI values by pixels on the image. Although theoretically, the NDVI ranges from \hl{-1.0} to +1.0, in this particular area of Mali, the actual range varies from -0.3 to 0.5 for the month of November for all years.
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of the NDVI of the Landsat \hl{8-9} images on Inner Niger Delta: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig08}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Soil Adjusted Vegetation Index (SAVI) based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig09}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Enhanced Vegetation Index (EVI) based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig11}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of EVI based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig12}
\end{figure}
