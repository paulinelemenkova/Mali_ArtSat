...
\newpar The process of computing SAVI vegetation index is performed in R library 'terra' using the code in Listing \ref{lst:03} (here: example for 2021, repeated likewise for all other images).
