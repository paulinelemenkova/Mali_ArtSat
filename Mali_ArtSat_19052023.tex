...
\newpar The results of the NDVI computation show \hl{changes} in vegetation \hl{from} 2013 to 2022, Figure \ref{fig:05}.

\begin{figure}[H]
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_05a.png}
		\caption{2013}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.90\textwidth]{Fig_05b.png}
		\caption{2015}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_05c.png}
		\caption{2018}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.90\textwidth]{Fig_05d.png}
		\caption{2020}
	\end{subfigure}%
\\
\vfill \vspace{1mm}
	\begin{subfigure}[b]{.5\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_05e.png}
		\caption{2021}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\textwidth}
		\centering
		\includegraphics[width=0.90\textwidth]{Fig_05f.png}
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{NDVI based on Landsat 8-9 OLI/TIRS images of Inner Niger Delta: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping: RStudio. Source: authors.}\label{fig:05}
\end{figure}
