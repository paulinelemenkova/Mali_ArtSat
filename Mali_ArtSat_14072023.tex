...
\newpar The time series analysis is based on the Landsat \hl{8-9} satellite images collected from the USGS survey \citep{Landsat9} on the surroundings of Mopti and Djenne, Mali. The metadata of the scenes are summarised in Table \ref{tab1}. The images were captured from the EarthExplorer repository, Figure \ref{fig03}. We used a series of the six Landsat \hl{8-9} images to map the areas of flooded vegetation within the area of Inner Niger Delta during the years 2013, 2015, 2018, 2020, 2021 and 2022. 
...
\begin{table}[H]
\scriptsize
\caption{Metadata of the satellite images used in this study: Landsat \hl{8-9} USGS \textsuperscript{1}.\label{tab1}}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Landsat \hl{8-9 images} of Inner Niger Delta in natural colour RGB values showing floodplain for six years (always November): (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022.}\label{fig04}
\end{figure}
...
\centering
	\includegraphics[width=14.0 cm]{Fig_05.jpg}
		\vspace*{20pt}\caption{Processing Landsat \hl{satellite} image in RStudio for extracting NDVI.
	\label{fig05}}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{NDVI based on Landsat \hl{8-9} images of Inner Niger Delta: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping: RStudio. Source: authors.}\label{fig06}
\end{figure}

\newpar The comparison of the computed values are summarised in Table \ref{tab2} based on the SpatRaster from Bands 4 and 5 of the Landsat-\hl{8} satellite images and shown in histograms of Figure \ref{fig07}. The lowest NDVI values in the study area were obtained from the Landsat-\hl{9} image in 2022/11/11 as -0.3072812, while the highest data are 0.5879165 received from the Landsat-\hl{9} image in 2013/11/10. 

\begin{table}[H]
\begin{threeparttable}
\scriptsize
\caption{Results of the NDVI computations of the Landsat \hl{8-9} satellite images.\label{tab2}}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of the NDVI of the Landsat \hl{8-9} images on Inner Niger Delta: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig07}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Soil Adjusted Vegetation Index (SAVI) based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig08}
\end{figure}
...
\begin{threeparttable}
\scriptsize
\caption{Results of the SAVI computations of the Landsat \hl{8-9} satellite images.\label{tab3}}
		\newcolumntype{C}{>{\centering\arraybackslash}X}
		\begin{tabularx}{\textwidth}{| p{2.0cm} | CCC | CCCC | p{1.8cm} | p{1.8cm} |}
		\toprule
	\bf{Time} & \multicolumn{3}{c|}{\bf{Dimensions}} & \multicolumn{4}{c|}{\bf{Extent}} & \multicolumn{2}{c|}{\bf{Extreme Values}} \\
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.5\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Enhanced Vegetation Index (EVI) based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Mapping visualization: RStudio. Source: authors.}\label{fig10}
\end{figure}
...
\vfill \vspace{1mm}
	...
	\begin{subfigure}[b]{.35\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
\vspace*{20pt}\caption{Histograms of EVI based on the Landsat \hl{8-9} images of Inner Niger Delta for November: (\textbf{a}) 2013, (\textbf{b}) 2015, (\textbf{c}) 2018, (\textbf{d}) 2020, (\textbf{e}) 2021, (\textbf{f}) 2022. Plots: RStudio. Source: authors.}\label{fig11}
\end{figure}

\begin{table}[H]
\begin{threeparttable}
\scriptsize
\caption{Results of the EVI2 computations of the Landsat \hl{8-9} satellite images.\label{tab4}}
	\newcolumntype{C}{>{\centering\arraybackslash}X}
	\begin{tabularx}{\textwidth}{| p{2.0cm} | CCC | CCCC | p{1.8cm} | p{1.8cm} |}
	\hline
	\bf{Time} & \multicolumn{3}{c|}{\bf{Dimensions}} & \multicolumn{4}{c|}{\bf{Extent}} & \multicolumn{2}{c|}{\bf{Extreme Values}} \\
...
\newpar The image classifications aimed at defining land cover types within the Inner Niger Delta of each Landsat \hl{8-9} scene were interpreted for each of the six evaluated years within the 2013--2022 time gap. Land cover types classified based on the \emph{k}-means clustering using Landsat \hl{8-9} images of Inner Niger Delta for November and visualise din Figures \ref{fig12} and \ref{fig13}. The notation for land cover classes are as follows: 1) Woodland; 2) Floodplain with aquatic grassland; 3) Savannah; 4) Thicket; 5) Wild rice; 6) Grassland; 7) Irrigated rice fields; 8) Savannah in shallow floodplain; 9) Bare soil (loams and clays); 10) Bare soil (sands); 11) Vegetation mosaics, main channel banks; 12) Lacustrine woodland; 13) Shallow lacustrine woodland; 14) Shrubby savannah in uplands; 15) Anthropic woody savannah; 16) Thicket in uplands; 17) Woody savannah in uplands; 18) Shrubby savannah in uplands; 19) Island palm grove; 20) Margins palm grove.
...
\centering
	...
	\vspace*{20pt}\caption{Correlation plot showing probability cases for land cover classes in the Inner Niger Delta between 2013 and 2022 based on the results of the clustering of the Landsat \hl{8-9} images \hl{using Kendall correlation method}. Mapping: Python. Source: authors.
	\label{fig14}}
\end{figure}
