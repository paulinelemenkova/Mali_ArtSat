...
\newpar The comparison of the computed values \hl{is} summarised in Table \ref{tab2} based on the SpatRaster from Bands 4 and 5 of the Landsat \hl{8-9} satellite images and shown in histograms of Figure \ref{fig07}. The lowest NDVI values in the study area were obtained from the Landsat-\hl{9} image in 2022/11/11 as -0.3072812, while the highest data are 0.5879165 received from the Landsat-\hl{8} image in 2013/11/10. 

\begin{table}[H]
\caption{Results of the NDVI computations of the Landsat \hl{8-9} satellite images.\label{tab2}}
\begin{tabularx}{\textwidth}{ YYY }
		\toprule
	\bf{Time} & \multicolumn{2}{c}{\bf{Extreme Values}} \\
	Date & minimal NDVI & maximal NDVI \\
	\midrule
	10 November 2013 & -0.2311377 & 0.5879165 \\
	\hline
	16 November 2015 & -0.2619293 & 0.5245128 \\
	\hline
	24 November 2018 & -0.2603942 & 0.5258653 \\
	\hline
	29 November 2020 & -0.2496693 & 0.4980780 \\
	\hline
	16 November 2021 & -0.2522458 & 0.5417392 \\
	\hline
	11 November 2022 & -0.3072812 & 0.5237642 \\
	\bottomrule
\end{tabularx}
\end{table}
