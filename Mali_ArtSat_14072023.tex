...
\newpar The time series analysis is based on the Landsat 8-9 OLI/TIRS satellite images collected from the USGS survey \citep{Landsat9} on the surroundings of Mopti and Djenne, Mali. The metadata of the scenes are summarised in Table \ref{tab1}. The images were captured from the EarthExplorer repository, Figure \ref{fig03}. We used a series of the six Landsat 8-9 OLI images to map the areas of flooded vegetation within the area of Inner Niger Delta during the years 2013, 2015, 2018, 2020, 2021 and 2022. 
...
\centering
	...
	\vspace*{20pt}\caption{The location of the Landsat \hl{8-9} satellite image \hl{in} Mali, Mopti region of the Inner Niger Delta\hl{. The images were }downloaded from the EarthExplorer repository, USGS. Background image\hl{: }ESRI World imagery.
	\label{fig03}}
\end{figure}
